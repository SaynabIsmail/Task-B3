...
def plot_candlestick(data, n_days=1):
    ...
    mpf.plot(resampled_data, type='candle', style='charles', title=f'Candlestick Chart',)
...
# ------------------------------------------------------------------------------
# Plot Candlestick and Boxplot Charts
# ------------------------------------------------------------------------------
plot_candlestick(data, n_days=5)  # 5 days aggregation for candlestick
plot_boxplot(data, n_days=5)  # 5 days aggregation for boxplot
